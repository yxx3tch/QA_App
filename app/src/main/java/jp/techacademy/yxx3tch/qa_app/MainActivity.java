...
public class MainActivity extends AppCompatActivity {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
            ...
            if (favoritesMap != null) {
                for (Object key : favoritesMap.keySet()) {
                    HashMap temp = (HashMap) favoritesMap.get((String) key);
                    String favorite = (String) temp.get("uid");
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            for (Question question: mQuestionArrayList) {
                if (dataSnapshot.getKey().equals(question.getQuestionUid())) {
                    // このアプリで変更がある可能性があるのは回答(Answer) もしくはお気に入り(Favorite)のみ
                    ...
                    if (favoritesMap != null) {
                        for (Object key : favoritesMap.keySet()) {
                            HashMap temp = (HashMap) favoritesMap.get((String) key);
                            String favorite = (String) temp.get("uid");
                            question.getFavorites().add(favorite);
                        }
                    }
    ...
    protected void onStart() {
        ...
        MenuItem favorite = navigationView.getMenu().findItem(R.id.nav_favorite);
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        // ログインしている場合はメニューにお気に入りへのリンクを追加
        if (user == null) {
